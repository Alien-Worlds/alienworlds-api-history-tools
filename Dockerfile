...
FROM node:17-alpine3.12 AS alienworlds-api-history-tools-builder
...
FROM node:17-alpine3.12 AS alienworlds-api-history-tools
...
COPY --from=alienworlds-api-history-tools-builder /var/history-tools/build ./build
